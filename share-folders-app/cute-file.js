#!/usr/bin/env node
// The first line is important. Although it is not valid JS, it is used on *nix
// systems to allow scripts to be executed as programs, which is exactly what
// we need in order to make the cute-files command available anywhere.
